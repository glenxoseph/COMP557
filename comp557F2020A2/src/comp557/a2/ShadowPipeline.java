...
public class ShadowPipeline {
	...
	// TODO: Objective 7
	private int VLightID;
    private int PLightID;
	...
	public ShadowPipeline( GLAutoDrawable drawable ) {
        ...
        VLightID = gl.glGetUniformLocation(basicLighting.glslProgramID, "VLight");
        PLightID = gl.glGetUniformLocation(basicLighting.glslProgramID, "PLight");
...
//		gl.glUniform1i( shadowMapID, 0 ); // texture unit zero
        ...
        basicLighting.glUniformMatrix(gl, VLightID, light.V);
		basicLighting.glUniformMatrix(gl, PLightID, light.P);
	}
...
//		gl.glUniform1i( depthTextureID, 0 ); // texture unit zero
		gl.glUniform1i( depthTextureID, 1 );
